...
public class KafkaProducerService {
    ...
    /**
     * case 3: This method is to send the Object Message to Kafka Topic with Header
     **/
    public CompletableFuture<SendResult<String, String>> sendResultAsync(Delivery delivery) throws JsonProcessingException, ExecutionException, InterruptedException {
        String key  = delivery.getId();
        String value = objectMapper.writeValueAsString(delivery);
